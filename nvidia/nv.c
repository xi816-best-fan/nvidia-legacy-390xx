...
static pci_ers_result_t nvidia_pci_error_detected   (struct pci_dev *, nv_pci_channel_state_t);
...
#ifndef NV_PCI_DEV_HAS_SKIP_BUS_PM
...
#if defined(NV_ACPI_VIDEO_H_PRESENT) && defined(NV_ACPI_VIDEO_BACKLIGHT_USE_NATIVE)
